...
```css
div {
  transform: translate(50px, 100px) || rotate(30deg) || scale(1, 2) || skew(
      20deg,
      30deg
    );
}
...
div {
  ...
  /&规定动画完成一个周期所花费的时间*/animation-timing-function: ease; /*规定动画的速度曲线 默认为"ease"*/
...
采用 Flex 布局的元素, 称为**Flex Container -> 容器**, 此容器的所有子元素自动成为容器成员,称为**Flex item -> 项目**

<img src="https://ws1.sinaimg.cn/large/ad9f1193gy1ftu45168dfj20f008qjrv.jpg">
...
1.  flex-direction 决定主轴的方向 即 item 的排列方向  
